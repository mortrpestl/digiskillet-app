    ...
    <body class="flex-column">
        <div class="front2 root">
            <div class="content_box">
                <img class="image" src="../styles/assets/digiskilletlogo.png" alt="alt text" onclick="return toggleNavigation()"/>
            ...
            <div class="content_box1">
                ...
                <a href="login.php" class="no_underline">
            ...
            <div class="navigation" id="navi"> <!-- ADD IMAGES BEFORE ADDING TO OTHER PAGES !! -->
                <a href="dashboard.php" class="no_underline">
                    <div class="navcell">
